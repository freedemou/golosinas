...
$.extend( $.validator, {
	...
	messages: {
		...
		birth_date: "Ingrese una fecha válida con formato DD/MM/YYYY",
	...
	prototype: {
		...
		showLabel: function( element, message, method) {
			if(method == 'required'){
				if($(element).attr("message") != undefined){
	...
	methods: {
		...
		birth_date: function( value, element ) {
